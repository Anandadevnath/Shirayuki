      ...
      <div className="relative w-full max-w-lg mx-auto mt-16">
        ...
        <div className="relative animate-fade-in-down">
          ...
          <div className="relative bg-black/80 backdrop-blur-xl border border-cyan-500/30 rounded-lg p-8 shadow-2xl shadow-cyan-500/10">
            <h1 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-400 to-cyan-400 mb-6 animate-gradient-text font-mono uppercase text-center tracking-wider">
              Forgot Password
            </h1>
            <ForgotPasswordForm />
          </div>
