...
const socialLinks = [
  ...
  {
    name: "GitHub",
    href: "https://github.com/Anandadevnath/Shirayuki",
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <a href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-2xl font-bold text-white">Shirayuki</span>
            </a>
            <p className="text-zinc-400 text-sm leading-relaxed mb-6 max-w-md">
              Shirayuki is your ultimate destination for streaming anime. Watch thousands of anime 
              episodes with English subtitles and dubbed versions, completely free.
            </p>
            {/* Social Links */}
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-zinc-500 text-sm">
            © {new Date().getFullYear()} Shirayuki. All rights reserved.
          </p>
