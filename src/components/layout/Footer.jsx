...
const SectionTitle = memo(({ children }) => (
  <h3 className="text-white font-semibold mb-4 sm:mb-6 flex items-center justify-center gap-2 text-base sm:text-lg">
              ...
              <div className="flex flex-wrap gap-1 sm:gap-1.5 justify-center">
                {genres.map((genre) => (
                  <Link
                    ...
                    className="px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-medium text-zinc-400 bg-white/5 border border-white/10 rounded-md sm:rounded-lg hover:bg-purple-500/20 hover:border-purple-500/50 hover:text-purple-300 transition-all duration-300"
                  >
                    {genre}
                  </Link>
                ))}
