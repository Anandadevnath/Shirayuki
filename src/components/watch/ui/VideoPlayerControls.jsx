...
export default function VideoPlayerControls({
  ...
  // Find the English subtitle track (fallback to first if not found)
  ...
  // Toggle captions: if on, turn off; if off, turn on English
      ...
      <div className="flex items-center gap-1">
        ...
        <div className="relative">
          <button
            ...
            className={`px-4 py-2 rounded-xl transition-all backdrop-blur-sm font-mono font-bold text-sm hover:bg-cyan-500/20 text-white/90 hover:text-cyan-300`}
        ...
        <button
          ...
          className={`p-2.5 rounded-xl transition-all backdrop-blur-sm ${captionsOn ? 'bg-gradient-to-r from-cyan-500/30 to-purple-500/30 text-cyan-300' : 'hover:bg-cyan-500/20 text-white hover:text-cyan-300'}`}
